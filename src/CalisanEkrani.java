...
public class CalisanEkrani extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ad_alani.setFont(new java.awt.Font("Lucida Grande", 0, 15)); // NOI18N

        soyad_alani.setFont(new java.awt.Font("Lucida Grande", 0, 15)); // NOI18N

        dept_alani.setFont(new java.awt.Font("Lucida Grande", 0, 15)); // NOI18N

        maas_alani.setFont(new java.awt.Font("Lucida Grande", 0, 15)); // NOI18N

        mesaj_yazisi.setForeground(new java.awt.Color(102, 255, 102));

        calisan_ekle.setText("Yeni\nÇalişan \nEkle");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(maas_alani, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(calisan_ekle, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(guncelle, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                                .addGap(18, 18, 18)
                                .addComponent(mesaj_yazisi, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(calisansil, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(calisan_ekle, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(guncelle, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(calisansil, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
    ...
    private void calisan_ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calisan_ekleActionPerformed
        ...
        islemler.calisaEkle(ad,soyad,departman,maas);
        calisanGoruntule();
        mesaj_yazisi.setText("Yeni Çalişan Başarılı bir şekilde eklendi.");
    ...
    private void calisan_tablosuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calisan_tablosuMouseClicked
        ...
        int selectedrow = calisan_tablosu.getSelectedRow(); // hangi satır seçili ise onu aldık
    ...
    private void guncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleActionPerformed
        ...
        if (selectedrow ==-1) {
            if (model.getRowCount()  == 0) { // tablomu bos mu 
            ...
            calisanGoruntule();
            mesaj_yazisi.setText("Çalişan Başarı ile guncellendi...");
    ...
    private void calisansilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calisansilActionPerformed
        ...
        mesaj_yazisi.setText(""); // mesaj yazısını temizledik.
        int selectedrow = calisan_tablosu.getSelectedRow();
        
        if (selectedrow == -1) {
            if (model.getRowCount() == 0) {
                mesaj_yazisi.setText("Çalişan tablosu şu anda boş...");
            }
            else {
                 mesaj_yazisi.setText("Lütfen Silinecek Çalışan Seçiniz...");
            }
        }
        else {
            int id = (int) model.getValueAt(selectedrow, 0);
            ...
            calisanGoruntule();
            mesaj_yazisi.setText("Çalişan Başarıyla Silindi...");
        }
    ...
    public void calisanGoruntule(){
        ...
        model.setRowCount(0); //calisan tablosu her seferinde bosalacak
